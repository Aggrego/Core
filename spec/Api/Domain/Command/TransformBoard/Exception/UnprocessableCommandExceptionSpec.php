...
namespace spec\Aggrego\Domain\Api\Domain\Command\TransformBoard\Exception;

use Aggrego\Domain\Api\Domain\Command\TransformBoard\Exception\UnprocessableCommandException;
